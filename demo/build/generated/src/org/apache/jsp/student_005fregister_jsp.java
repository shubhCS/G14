...
{
	String fname,lname,email,cpass,password;
	...
	try{
		...
		String sql="insert into s values('"+fname+"','"+lname+"','"+email+"','"+password+"')";
		int res=st.executeUpdate(sql);
		if(res!=0)
			out.println("<br><font-color:white>Your account has been created</font>");
		else
